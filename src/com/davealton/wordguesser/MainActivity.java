package com.davealton.wordguesser;

import java.util.ArrayList;
import java.util.Collections;
import java.util.Random;

import com.davealton.wordguesser.R;
...
public class MainActivity extends Activity {
	...
	public void setNewRandomWord() {
		String[] randomWords = {"Seventy", "Football", "Skip", "Rabbit", "Arm", "Crayon", "Jump", "Pig", "Monkey", "Baby", "Happy", "Hopscotch", "Spider", "Bird", "Doll", "Wings", "Turtle", "Room", "Drum", "Ear", "Cheek", "Smile", "Jar", "Telephone", "Mouth", "Basketball", "Airplane", "Tree", "Star", "Point", "Scissors", "Elephant", "Jump", "Chair", "Pinch", "Mosquito", "Sunglasses", "Head", "Kick", "Football", "Skip", "Dance", "Alligator", "Stop", "Door", "Blinking", "Swing", "Pen", "Apple", "Seven"};
	    ...
	    if(randomWord.length() == level){
		    ArrayList<Character> chars = new ArrayList<Character>(randomWord.length());
